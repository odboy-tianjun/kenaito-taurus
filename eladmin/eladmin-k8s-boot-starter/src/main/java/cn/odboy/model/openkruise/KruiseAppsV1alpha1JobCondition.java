...
public class KruiseAppsV1alpha1JobCondition {
    ...
    public KruiseAppsV1alpha1JobCondition lastProbeTime(Date lastProbeTime) {
    ...
    public KruiseAppsV1alpha1JobCondition lastTransitionTime(Date lastTransitionTime) {
