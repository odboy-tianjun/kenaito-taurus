...
public class KruiseAppsV1alpha1ContainerProbeState {
    ...
    private Date lastProbeTime = null;
    ...
    public KruiseAppsV1alpha1ContainerProbeState lastProbeTime(Date lastProbeTime) {
    ...
    public KruiseAppsV1alpha1ContainerProbeState lastTransitionTime(Date lastTransitionTime) {
