...
public class KruiseAppsV1alpha1ImageListPullJobStatus {
    ...
    public KruiseAppsV1alpha1ImageListPullJobStatus completionTime(Date completionTime) {
    ...
    public KruiseAppsV1alpha1ImageListPullJobStatus startTime(Date startTime) {
