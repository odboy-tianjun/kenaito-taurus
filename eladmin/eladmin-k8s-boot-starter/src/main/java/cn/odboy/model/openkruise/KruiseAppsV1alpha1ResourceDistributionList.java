...
/**
 * ResourceDistributionList is a list of ResourceDistribution
 */
@ApiModel(description = "ResourceDistributionList is a list of ResourceDistribution")
...
public class KruiseAppsV1alpha1ResourceDistributionList {
    ...
    /**
     * List of resourcedistributions. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
     *
     * @return items
     **/
    @ApiModelProperty(required = true, value = "List of resourcedistributions. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KruiseAppsV1alpha1ResourceDistributionList)) {
            return false;
        }
        KruiseAppsV1alpha1ResourceDistributionList ioKruiseAppsV1alpha1ResourceDistributionList = (KruiseAppsV1alpha1ResourceDistributionList) o;
        return Objects.equals(this.apiVersion, ioKruiseAppsV1alpha1ResourceDistributionList.apiVersion) &&
                Objects.equals(this.items, ioKruiseAppsV1alpha1ResourceDistributionList.items) &&
                Objects.equals(this.kind, ioKruiseAppsV1alpha1ResourceDistributionList.kind) &&
                Objects.equals(this.metadata, ioKruiseAppsV1alpha1ResourceDistributionList.metadata);
    }
