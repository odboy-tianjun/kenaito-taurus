...
public class KruiseAppsV1alpha1FailurePolicy {
     ...
     * @return type
     **/
    @ApiModelProperty(value = "Type indicates the type of FailurePolicyType. Default is FailurePolicyTypeFailFast.")
    ...
    public String toString() {
        ...
        sb.append("class KruiseAppsV1alpha1AdvancedCronJobSpecTemplateBroadcastJobTemplateSpecFailurePolicy {\n");
