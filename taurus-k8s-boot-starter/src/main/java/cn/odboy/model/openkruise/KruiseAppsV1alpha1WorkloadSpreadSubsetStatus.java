...
public class KruiseAppsV1alpha1WorkloadSpreadSubsetStatus {
    ...
    private Map<String, Date> creatingPods = null;
    @SerializedName("deletingPods")
    private Map<String, Date> deletingPods = null;
    ...
    public KruiseAppsV1alpha1WorkloadSpreadSubsetStatus creatingPods(Map<String, Date> creatingPods) {
        this.creatingPods = creatingPods;
        return this;
    }

    public KruiseAppsV1alpha1WorkloadSpreadSubsetStatus putCreatingPodsItem(String key, Date creatingPodsItem) {
        if (this.creatingPods == null) {
            this.creatingPods = new HashMap<String, Date>();
        }
    ...
    public Map<String, Date> getCreatingPods() {
        return creatingPods;
    }

    public void setCreatingPods(Map<String, Date> creatingPods) {
        this.creatingPods = creatingPods;
    }

    public KruiseAppsV1alpha1WorkloadSpreadSubsetStatus deletingPods(Map<String, Date> deletingPods) {
        this.deletingPods = deletingPods;
        return this;
    }

    public KruiseAppsV1alpha1WorkloadSpreadSubsetStatus putDeletingPodsItem(String key, Date deletingPodsItem) {
        if (this.deletingPods == null) {
            this.deletingPods = new HashMap<String, Date>();
        }
    ...
    public Map<String, Date> getDeletingPods() {
        return deletingPods;
    }

    public void setDeletingPods(Map<String, Date> deletingPods) {
        this.deletingPods = deletingPods;
    }
