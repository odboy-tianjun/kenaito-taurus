...
import cn.odboy.vital.domain.CalendarDict;
...
public class CalendarDictServiceImpl extends ServiceImpl<CalendarDictMapper, CalendarDict> implements CalendarDictService {
    ...
    @Override
    public List<MetaOptionModel> listMetaMonthsByLunarYear(BirthDate.ListMetaMonthByLunarYear args) {
        ...
        return calendarDicts.stream().map(m -> MetaOptionModel.builder()
    ...
    @Override
    public List<MetaOptionModel> listMetaDaysByLunarYearMonth(BirthDate.ListMetaDaysByLunarYearMonth args) {
        List<CalendarDict> calendarDicts = lambdaQuery()
                .eq(CalendarDict::getLunarYear, args.getLunarYear())
