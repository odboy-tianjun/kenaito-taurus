...
import cn.odboy.vital.domain.ContactInfo;
import cn.odboy.vital.service.ContactInfoService;
...
public class ContactInfoController {
    ...
    public ResponseEntity<Object> searchContactInfos(@Validated @RequestBody PageArgs<ContactInfo> args) {
        Page<ContactInfo> page = new Page<>(args.getPage(), args.getPageSize());
        return new ResponseEntity<>(contactInfoService.searchContactInfos(args.getBody(), page), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> listMetaContactInfos(@Validated @RequestBody PageArgs<ContactInfo> args) {
        Page<ContactInfo> page = new Page<>(args.getPage(), args.getPageSize());
        return new ResponseEntity<>(contactInfoService.listMetaContactInfos(args.getBody(), page), HttpStatus.OK);
    }
}
